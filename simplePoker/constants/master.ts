...
export const getMyHandPreflop = (cards: ICard[]) => {
  ...
  if (cards[0].cardNumber === cards[1].cardNumber) {
    switch (cards[0].cardNumber) {
      case 14:
        return i18n.t("pre.aa");
      case 13:
        return i18n.t("pre.kk");
      case 12:
        return i18n.t("pre.qq");
      case 11:
        return i18n.t("pre.jj");
  ...
  switch (cards[1].cardNumber) {
    case 14:
      switch (cards[0].cardNumber) {
        case 13:
          return i18n.t("pre.ak", suited);
        case 12:
          return i18n.t("pre.aq", suited);
        case 11:
    ...
    case 13:
      switch (cards[0].cardNumber) {
        case 12:
          return i18n.t("pre.kq", suited);
        case 11:
          return i18n.t("pre.kj", suited);
        case 10:
          return i18n.t("pre.k10", suited);
        default:
